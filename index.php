...
if(!empty($_SESSION["id"])){
  $id = $_SESSION["id"];
  $result = mysqli_query($conn, "SELECT * FROM loginpage WHERE id = $id");
...
<body>
    ...
    <section class="home">
        <div class="text"><b>RecipeBook</b></div>
        <div class="alang">
        <a href="Indian.html"><div class="segment"> Indian</div></a>
        <a href="continental.html"><div class="segment1"> Continental</div></a>
