...
if(isset($_POST["submit"])){
  ...
  $duplicate = mysqli_query($conn, "SELECT * FROM loginpage WHERE email = '$email'");
  if(mysqli_num_rows($duplicate) > 0){
    echo
    "<script> alert('Username or Email Has Already Taken'); </script>";
  }
  else{
      $query = "INSERT INTO loginpage VALUES('','$name','$email','$password')";
    ...
    <div class="container" id="container">
        ...
        <div class="form-container sign-in-container">
            <form action="#">
                ...
                <a href="submit.html"><button type="submit" name="submit">Sign Up</button></a>
                <a href="login.php"><button id="signUp" >Sign In</button></a>
            </form>
        </div>
    </div>
